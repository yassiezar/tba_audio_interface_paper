...
This could indicate that, instead of terminating the experiment by bringing the two sequences within one interval of one another \tofix{I would just say ``terminating the experiment as explained in Sec.~\ref{sec:sound_localisation}'', but then there you said within two intervals, not one...}, there was more switching back and forth between the three central intervals. 
...
\tofix{The $\Delta f$ explanation should be moved to Sec.~\ref{sec:pitch_discrimination}}
