...
\begin{figure}[t]
  \centering
  \subfloat[]{\label{fig:tango-headphone}\includegraphics[width=0.6\columnwidth]{figures/tango_tablet_headphone_edit.pdf}}
~
  \subfloat[]{\label{fig:participant}\includegraphics[width=0.3\columnwidth]{figures/vi_participant.pdf}}
