...
The results from the experiments we performed allow us to better understand how the users respond to different settings for the spatial audio feedback stimulus and use them to improve and optimize the behaviour of the feedback modes in our portable navigation aid.
...
Both groups were given some time before the target-search experiment to familiarize themselves with the system, the audio signal's behaviour and the \SI{512}{\hertz} on-level tone. 
