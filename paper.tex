...
\hlbreakable{The virtual targets have a programmed radius of approximately \SI{10}{\centi\metre}, but the participants were not explicitly informed when they were within this radius and had to use their own subjective judgement of the audio tone.
...
\hlbreakable{Note that the cut-off thresholds in \cref{fig:pitch-thresholds-hist} are transformed from the logarithmic semitone scale in \cref{fig:pitch-thresholds} to a linear Hertz-based scale for visualisation purposes to make the separation between the settings more clearly visible.}
