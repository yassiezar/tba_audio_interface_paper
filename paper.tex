...
~
  ...
  \caption{A Tango tablet and the bone-conduction headphones, the primary hardware components used in this work (left), and a participant with visual impairments using the system during an experiment (right). Adapted from~\citet{lock2019bone}.}
...
Over the years, commercial and academic groups have devised new and innovative mobile navigation and travel aids for people with visual impairments.
...
Furthermore, both haptic and vocal feedback can present a cognitive burden and overwhelm a user's input bandwidth, particularly when high-resolution guidance is required.
