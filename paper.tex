...
\author{%
  \name{Jacobus C. Lock\textsuperscript{a}\thanks{Contact Author}, Iain D. Gilchrist\textsuperscript{b}, Grzegorz Cielniak\textsuperscript{a} and Nicola Bellotto\textsuperscript{a}}%
...
\begin{abstract}
  ...
  In addition to producing results comparable to the state-of-the-art, we found that Fitts's Law can be used to form a metric that can be used to improve and refine the quality of the audio interface in future mobile navigation aids. 
\end{abstract}
...
Improvements to computer vision and machine learning techniques, as well as mobile computing hardware improvements are exploited to make this system possible.
...
~
  ...
  \caption{Pictures of the former Tango tablet and the bone-conduction headphones used in this work (left), and a participant with visual impairments during an experiment (right).}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/pitch_discrimination.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/pitch_thresholds.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/pitch_thresholds_limits.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/boxplot_target_search_median_error.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/boxplot_target_search_absolute_median_error.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/fitts_ips.png}
