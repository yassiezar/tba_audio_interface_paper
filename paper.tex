...
The similarity between the differences is further highlighted with non-significant results from the two-sided Kolmogorov-Smirnov test, where none of the $p$-values are significant.
...
\begin{highlighted}
Since Fitts's model we used here is based on the target estimation errors, it is reasonable to expect that the accuracy and time performances will follow similar trends. 
