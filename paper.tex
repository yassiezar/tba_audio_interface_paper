...
Group \textit{G2} contained 10 people (7 male, 3 female) with severe visual impairments (mean age: $73\pm20$).
...
This could be due to each participant's result being taken as a single datum and to the smaller population size in Group~\textit{G2}, as well as the mean age and general level expertise with mobile devices of this particular group.
